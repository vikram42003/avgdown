...
const SummaryCard = ({ title, value }: SummaryCardPropTypes) => {
  return (
    <div className="max-w-64 glass-primary px-2 py-4 rounded-md w-full flex flex-col gap-1">
...
const DashboardSummaryCards = () => {
  ...
  return (
    <div className="mt-12 mb-8 flex justify-between lg:justify-around gap-8 text-center">
